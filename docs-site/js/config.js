...
const COMMANDS_DATA = {
  ...
  games: {
    ...
    commands: [
      ...
      {
        name: "hangman",
        desc: "Jouer au pendu en groupe",
        usage: ".hangman start / .hangman guess <lettre>",
        example: ".hangman start",
      },
      {
        name: "wordle",
        desc: "Résoudre un mot caché quotidien",
        usage: ".wordle start / .wordle <lettre>",
      ...
      {
        name: "roulette",
        desc: "Mini-jeu de roulette avec mise et gains",
        usage: ".roulette [montant]",
        example: ".roulette 10",
      },
      {
        name: "wyr",
        desc: "Would You Rather avec des choix amusants",
        usage: ".wyr",
        example: ".wyr",
      },
      {
        name: "rps",
        desc: "Pierre feuille ciseaux contre le bot",
        usage: ".rps <pierre|feuille|ciseaux>",
        example: ".rps pierre",
      },
      {
        name: "8ball",
        desc: "Obtenir une réponse aléatoire de la boule magique",
        usage: ".8ball <question>",
        example: ".8ball Serai-je riche ?",
      },
      {
        name: "scramble",
        desc: "Retrouver le mot mélangé",
        usage: ".scramble start / .scramble <mot>",
        example: ".scramble start",
      },
      {
        name: "gameleaderboard",
        desc: "Consulter le classement des jeux du groupe",
        usage: ".gameleaderboard",
        example: ".gameleaderboard",
      },
  ...
  group: {
    ...
    commands: [
      ...
      {
        name: "invite",
        desc: "Afficher ou révoquer le lien d'invitation du groupe",
        usage: ".invite / .invite reset",
        example: ".invite",
      },
      {
        name: "lock / unlock",
        desc: "Verrouiller ou déverrouiller les messages du groupe",
        usage: ".lock / .unlock",
        example: ".lock",
      },
      {
        name: "antilink",
        desc: "Activer la protection contre les liens externes",
        usage: ".antilink on/off",
        example: ".antilink on",
      },
      {
        name: "antiflood",
        desc: "Bloquer le flood de messages en groupe",
        usage: ".antiflood on/off [seuil]",
        example: ".antiflood on 5",
      },
      {
        name: "antiword",
        desc: "Filtrer les mots interdits dans les groupes",
        usage: ".antiword on/off/add/remove/list",
        example: ".antiword add spam",
      },
      {
        name: "captcha",
        desc: "Activer une vérification captcha pour les nouveaux membres",
        usage: ".captcha on/off",
        example: ".captcha on",
      },
      {
        name: "grouprules",
        desc: "Définir ou consulter les règles du groupe",
        usage: ".grouprules / .grouprules set <texte>",
        example: ".grouprules set Pas de spam",
      },
      {
        name: "randommember",
        desc: "Sélectionner un membre au hasard",
        usage: ".randommember",
        example: ".randommember",
      },
      {
        name: "reputation",
        desc: "Afficher ou gérer la réputation des membres",
        usage: ".rep / .rep @membre / .rep leaderboard",
        example: ".rep leaderboard",
      },
      {
        name: "activity",
        desc: "Voir les membres les plus actifs du groupe",
        usage: ".activity [limit]",
        example: ".activity 10",
      },
      {
        name: "welcome",
