...
const WORDS = [
  "piano", "table", "fleur", "plage", "nuage", "route", "chien", "fille",
  "livre", "coeur", "solde", "vigne", "rêver", "laser", "filet", "poule",
  "boire", "vague", "titre", "matin", "femme", "monde", "vitre", "pompe",
  "foule", "cycle", "plume", "rouge", "ville", "image", "bague", "piste",
  "tarte", "arbre", "sucre", "linge", "forêt", "boeuf", "règle", "sable",
];
...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (sub === "stop") {
      ...
      return await message.reply(`🛑 Partie arrêtée. Le mot était : *${game.word.toUpperCase()}*`);
    }
  ...
  async handleMessage(message) {
    ...
    let display = game.attempts.map((a) => `${a.grid} ${a.guess.toUpperCase()}`).join("\n");
